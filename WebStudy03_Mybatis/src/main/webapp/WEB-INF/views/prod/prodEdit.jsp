...
<table>
		...
		<tr>
			<th>상품분류</th>
			<td><select required name="prodLgu" class="form-control">
		...
		<tr>
			...
			<span class="error">${errors.prodImg}</span></td>
		</tr>
		<tr>
			<th>총재고</th>
...
<script>
	$(':input[name=prodLgu]').val('${prod.prodLgu}').change();
	$(':input[name=prodBuyer]').val('${prod.prodBuyer}').change();
