 ...
 *  
 *  : 자원의 검색과 로딩은 ResouceLoader 의 영역.
 *   - 자원 검색에 prefix 활용 ex) classpath:, file: .
 *   	prefix 에 따라 검색 시작 위치가 런타임에 결정됨.
 *   - 모든 컨테이너는 ResourceLoader 의 구현체임.
 * 
 */
@Slf4j
...
//		Resource res1 = resourceLoader.getResource("https://www.google.com/images/branding/googlelogo/1x/googlelogo_light_color_272x92dp.png");
//		Resource res2 = resourceLoader.getResource("classpath:kr/or/ddit/db/dbInfo.properties");
//		Resource res3 = resourceLoader.getResource("file:D:\\02.medias\\images\\cute4.JPG");
