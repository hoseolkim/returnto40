...
<table>
	<form:form enctype="multipart/form-data" modelAttribute="prod">
			...
			<tr>
				<th>이미지</th>
				<td>
					<input name="prodImage" id="prodImage" type="file" class="form-control" required />
			...
			<tr>
				<th>크기</th>
				<td><form:input path="prodSize" class="form-control" /><form:errors path="prodSize" element="span" cssClass="error" /></td>
			</tr>
			<tr>
				<th>색상</th>
			...
			<tr>
				<th>배송방법</th>
				<td><form:input path="prodDelivery" class="form-control" /><form:errors path="prodDelivery" element="span" cssClass="error" /></td>
			</tr>
			<tr>
				<th>단위</th>
