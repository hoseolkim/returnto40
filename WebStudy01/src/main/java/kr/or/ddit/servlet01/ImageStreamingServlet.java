...
//		String value = config.getInitParameter("imageFolder");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Cookie savedImageName = new Cookie("savedImageName",imageName);
		savedImageName.setPath(request.getContextPath());
		savedImageName.setMaxAge(7*24*60*60);
		response.addCookie(savedImageName);
